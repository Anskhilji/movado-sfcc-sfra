...
target.compileFonts = function () {
    var fontsDir = 'cartridges/olivia-burton-uk/cartridge/static/default/fonts';
    mkdir('-p', fontsDir);
    cp('-r', 'node_modules/font-awesome/fonts/', 'cartridges/olivia-burton-uk/cartridge/static/default');
...
target.release = function (args) {
    ...
    if (['patch', 'minor', 'major'].indexOf(type) >= 0) {
        ...
        var propertiesFileName = path.resolve('./cartridges/olivia-burton-uk/cartridge/templates/resources/version.properties')
