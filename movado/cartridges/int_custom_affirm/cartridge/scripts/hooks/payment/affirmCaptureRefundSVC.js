...
function capture(order, amount, sendMail) {
    try {
        ...
        if (callResult.isOk() == false) {
            Logger.error('Affiem: Call error code' + callResult.getError().toString() + ' Error => ResponseStatus: ' + callResult.getStatus() + ' | ResponseErrorText: ' + callResult.getErrorMessage() + ' | ResponseText: ' + callResult.getMsg());
