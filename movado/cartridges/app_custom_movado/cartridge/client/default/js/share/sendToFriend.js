 ...
 */
function share() {
    $('body').on('click', '.email-share', function (evt) {
        evt.preventDefault();
        var endPointUrl = $(evt.target).closest('a').attr('href');
        $.spinner().start();
        formHelpers.clearPreviousErrors('#sendtofriendform');
        $.ajax({
            url: endPointUrl,
            type: 'get',
            success: function (response) {
                $('#sendtofriendform').find('.modal-content').html(response);
                $('.server-error').hide();
 ...
 */
function send() {
    $('body').on('click', '#sendtofriendformsend', function (e) {
        e.preventDefault();
        $.spinner().start();
        formHelpers.clearPreviousErrors('#sendtofriendform');
...
$(document).ready(function () {
    ...
    $('#sendtofriendform').on('hidden.bs.modal', function (evt) {
