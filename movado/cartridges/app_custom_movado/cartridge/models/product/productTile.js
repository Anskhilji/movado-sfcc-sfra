...
module.exports = function productTile(product, apiProduct, productType, params) {
    ...
    */
    ...
    if (!params.images || params.images == true) {
        decorators.images(product, apiProduct, { types: ['tile300', 'tile533','tile640' ,'tile520', 'tile256', 'tile217', 'tile150', 'tile512', 'tile300X375','tile512X640','tile532X300', 'tile300X300', 'tile180','tile444X600','tile189X260'], quantity: 'all' });
    }
