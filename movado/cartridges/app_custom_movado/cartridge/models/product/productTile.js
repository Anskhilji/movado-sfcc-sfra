    ...
    if (!hit) {
        ...
        while (searchHits.hasNext()) {
            ...
            if (tempHit.firstRepresentedProductID === apiProduct.ID) {
                hit = tempHit;
            } else if (!empty(apiProduct) && !empty(apiProduct.variants) && apiProduct.variants.length > 0 && tempHit.hitType == 'slicing_group' || tempHit.hitType == Constants.VARIATION_GROUP) {
