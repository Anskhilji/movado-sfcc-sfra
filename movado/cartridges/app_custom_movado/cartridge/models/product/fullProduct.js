...
module.exports = function fullProduct(product, apiProduct, options) {
    ...
    if (options.variationModel) {
        ...
        decorators.images(product, options.variationModel, { types: ['pdp533','tileEyeWear','tile150', 'zoom830', 'zoom1660', 'gallery'], quantity: 'all' });
    } else {
     // Custom Start: Define view type for 'gallery' for DIS
        decorators.images(product, apiProduct, { types: ['pdp533','tileEyeWear','tile150', 'zoom830', 'zoom1660', 'gallery'], quantity: 'all' });
    }
