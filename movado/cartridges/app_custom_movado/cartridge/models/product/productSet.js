...
module.exports = function setProduct(product, apiProduct, options, factory) {
    ...
    if (options.variationModel) {
        ...
        decorators.images(product, options.variationModel, { types: ['pdp533','tile532X300','tile640','tile520','tile300','tile150', 'tile156', 'zoom830', 'zoom1660', 'gallery','tile300X375','tile512X640', 'tile256', 'tile300X300','pdp600', 'tile100', 'pdp700','tile512','tile512Xtile640','tile640Xtile764','zoom691X830', 'posterFrame'], quantity: 'all' });
    } else {
     // Custom Start: Define view type for 'gallery' for DIS
        decorators.images(product, apiProduct, { types: ['pdp533','tile260xtile340','tile532X300','tile640','tile520','tile300','tile150', 'tile156', 'zoom830', 'zoom1660', 'gallery','tile300X375','tile512X640', 'tile256', 'tile300X300','pdp600', 'tile100', 'pdp700','tile512','tile512Xtile640','tile640Xtile764','zoom691X830', 'posterFrame'], quantity: 'all' });
    }
