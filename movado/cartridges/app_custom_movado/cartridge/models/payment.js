...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        ...
        results.selectedAdyenPM = paymentInstrument.custom.adyenPaymentMethod ? paymentInstrument.custom.adyenPaymentMethod : null;
        results.selectedIssuerName = paymentInstrument.custom.adyenIssuerName ? paymentInstrument.custom.adyenIssuerName : null;

        if (paymentInstrument.paymentMethod === 'CREDIT_CARD') {
            results.lastFour = paymentInstrument.creditCardNumberLastDigits;
            results.owner = paymentInstrument.creditCardHolder;
            results.expirationYear = paymentInstrument.creditCardExpirationYear;
            results.formattedExpirationYear = paymentInstrument.creditCardExpirationYear.toString().substring(0, 2);
