    ...
    if (listrakEnabled && listrakTransactionalSwitch == Constants.LTK_TRANSACTIONAL_SWITCH) {
        switch (emailObj.type) {
            ...
            case 4:
                ...
                requestParams.messageId = context.currentOrder.custom.storePickUp ? Site.current.preferences.custom.Listrak_BopisOrderConfirmation : Site.current.preferences.custom.Listrak_OrderConfirmationMessageID;
