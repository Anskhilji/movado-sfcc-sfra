...
describe('Wishlist MoreResults', function () {
    ...
    it('should return the first page of a search result', function () {
        ...
        var queryString = '?firstName=&lastName=WLuser&uuids=%5B%5D&pageNumber=1';
        mySearchRequest.url = config.baseUrl + '/Wishlist-MoreResults' + queryString;
        ...
        return request(mySearchRequest)
            .then(function (response) {
                ...
                assert.equal(bodyAsJson.results.firstName, expectedResult1.results.firstName);
    ...
    it('should return the second / last page in a search result of wishlist', function () {
        ...
        var queryString = '?firstName=&lastName=WLuser&uuids=%5B%5D&pageNumber=2';
        mySearchRequest.url = config.baseUrl + '/Wishlist-MoreResults' + queryString;
        ...
        return request(mySearchRequest)
            .then(function (response) {
                ...
                assert.equal(bodyAsJson.results.firstName, expectedResult2.results.firstName);
    ...
    it('should return hit when first name is used.', function () {
        ...
        var queryString = '?firstName=WLUser1&lastName=&uuids=%5B%5D&pageNumber=1';
        mySearchRequest.url = config.baseUrl + '/Wishlist-MoreResults' + queryString;
    ...
    it('should return hit when both first name and last name are used.', function () {
        ...
        var queryString = '?firstName=WLUser2&lastName=WLuser&uuids=%5B%5D&pageNumber=1';
        mySearchRequest.url = config.baseUrl + '/Wishlist-MoreResults' + queryString;
    ...
    it('should return empty hits when there is no match.', function () {
        ...
        var queryString = '?firstName=&lastName=abc&uuids=%5B%5D&pageNumber=1';
        mySearchRequest.url = config.baseUrl + '/Wishlist-MoreResults' + queryString;
