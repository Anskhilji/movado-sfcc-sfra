    ...
    addProductToCart: function() {
        ...
        // Adds a product.
            ...
            if (productToAdd.object.isProductSet()) {
                ...
                cart.addProductItem(productToAdd.object, params.Quantity.doubleValue, productOptionModel, params);
            }
            ...
            if (product) {
                ...
                if (productInCart) {
                    if (productInCart.optionModel) {
                        ...
                        addClydeContract.addContractsToCart(quantity, params, shipment, cart.object, productLineItems, params.pid.stringValue);
