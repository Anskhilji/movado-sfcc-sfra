...
if (fs.existsSync(path.join(__dirname, './cartridges/app_custom_ob_redesign/cartridge/client/default/js/'))) {
    var jsFiles = shell.ls(path.join(__dirname, './cartridges/app_custom_ob_redesign/cartridge/client/default/js/*.js'));
    ...
    configs.push({
        ...
        entry: jsEntries,
        output: {
            path: path.resolve(path.join(__dirname, './cartridges/app_custom_ob_redesign/cartridge/static/default/js')),
            filename: '[name].js'
        },
        module: {
            rules: [
