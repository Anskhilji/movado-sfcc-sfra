...
var baseSearchRefinements = module.superModule;
...
function getAttributeRefinementValueModel(refinementDefinition) {
    ...
    } else if (refinementDefinition.attributeID === 'color') {
...
baseSearchRefinements.get = get;
module.exports = baseSearchRefinements;
