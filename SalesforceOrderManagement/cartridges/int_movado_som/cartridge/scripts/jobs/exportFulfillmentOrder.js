...
function exportFulfillmentOrder(args) {
  ...
  var exportData = SalesforceModel.createSaleforceRestRequest({
    requestMethod: 'GET',
  ...
  if (responseBody.length) {
        responseBody.forEach(function (record) { //eslint-disable-line
          ...
          if (streamWriter) {
            ...
            writeXmlElement(streamWriter, 'ShiptoName2', (Object.hasOwnProperty.call(record, 'shiptoName2')) ? record.poHeader.shiptoName2 : '');
            writeXmlElement(streamWriter, 'ShiptoCompany', (Object.hasOwnProperty.call(record, 'shipToCompany')) ? record.poHeader.shipToCompany : '');
            ...
            writeXmlElement(streamWriter, 'ShiptoAddress2', (Object.hasOwnProperty.call(record, 'shipToAddress2')) ? record.poHeader.shipToAddress2 : '');
            writeXmlElement(streamWriter, 'ShiptoAddress3', (Object.hasOwnProperty.call(record, 'shipToAddress3')) ? record.poHeader.shipToAddress3 : '');
            writeXmlElement(streamWriter, 'ShiptoAddress4', (Object.hasOwnProperty.call(record, 'shipToAddress4')) ? record.poHeader.shipToAddress4 : '');
            ...
            writeXmlElement(streamWriter, 'BilltoAddress2', (Object.hasOwnProperty.call(record, 'billToAddress2')) ? record.poHeader.billToAddress2 : '');
            writeXmlElement(streamWriter, 'BilltoAddress3', (Object.hasOwnProperty.call(record, 'billToAddress3')) ? record.poHeader.billToAddress3 : '');
            writeXmlElement(streamWriter, 'BilltoAddress4', (Object.hasOwnProperty.call(record, 'billToAddress4')) ? record.poHeader.billToAddress4 : '');
            ...
            // @todo get pricebook ID
            writeXmlElement(streamWriter, 'PriceBookId', 'ECOM_RP_USD');
            ...
            writeXmlElement(streamWriter, 'SubTotal', record.poHeader.subTotal);
            writeXmlElement(streamWriter, 'TotalTax', record.poHeader.totalTax);
            writeXmlElement(streamWriter, 'TotalDutyAmount', '');
            ...
            writeXmlElement(streamWriter, 'NetAmount', record.poHeader.netAmount);
            writeXmlElement(streamWriter, 'AuthAmount', record.poHeader.authAmount);
            ...
            record.poItems.forEach(function (poItem) {
              ...
              writeXmlElement(streamWriter, 'GrossValue', poItem.grossValue);
              writeXmlElement(streamWriter, 'PromoCode', (Object.hasOwnProperty.call(poItem, 'promoCode')) ? poItem.promoCode : '');
              writeXmlElement(streamWriter, 'PromoAmount', poItem.promoAmount);
              writeXmlElement(streamWriter, 'RoundingAmount', '');
              writeXmlElement(streamWriter, 'LoyaltyAmount', '');
              writeXmlElement(streamWriter, 'SubTotal', poItem.subTotal, true);
              writeXmlElement(streamWriter, 'TaxAmount', poItem.taxAmount, true);
              ...
              writeXmlElement(streamWriter, 'NetAmount', poItem.netAmount, true);
              writeXmlElement(streamWriter, 'ShippingCost', '');
