...
test.describe('Setup', () => {
    test('Try to setup TikTok for Business on Business Manager', async () => {
        ...
        await page.getByLabel('Organization ID (e.g.: f_ecom_zzte_053)*').click();
        await page.getByLabel('Organization ID (e.g.: f_ecom_zzte_053)*').fill(String(process.env.BM_ORGID));
