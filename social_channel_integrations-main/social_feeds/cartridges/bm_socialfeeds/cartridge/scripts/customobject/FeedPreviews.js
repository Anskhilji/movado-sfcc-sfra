...
function generatePreview() {
    ...
    var CSVExportHandler = require('int_socialfeeds/cartridge/scripts/export/handlers/CSVExportHandler.ds').CSVExportHandler;
    var TemplateExportHandler = require('int_socialfeeds/cartridge/scripts/export/handlers/TemplateExportHandler.ds').TemplateExportHandler;
    ...
    switch (feedPreviewFormat) {
        ...
        case 'CSV':
            ...
            handler = new CSVExportHandler(writer, config.separator, config.fields, config.header, feedContext, 'true', 'true', 'true', 'true', co.custom.socialCategory, co.custom.googleShoppingCategories);
            break;
    }
